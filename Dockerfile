...
COPY --from=build /app/ontologie.rdf /tmp/
...
# COPY ./ontology/ontologie.rdf /jena-fuseki/run/databases/dataset/
...
# CMD /jena-fuseki/fuseki-server --file=/tmp/ontologie.rdf /cap-vert-dish && npm start --prefix fuseki/build/